...
console.log(`"typeof person.constructor" --> ${typeof person.constructor}`);
console.log(`"typeof Function.constructor" --> ${typeof Function.constructor}`);
...
console.log(`"typeof anotherPerson.constructor" --> ${typeof anotherPerson.constructor}`);
console.log(`"anotherPerson.constructor === Person" --> ${anotherPerson.constructor === Person}`);
console.log(`"anotherPerson.constructor === AnotherPerson" --> ${anotherPerson.constructor === AnotherPerson}`);
